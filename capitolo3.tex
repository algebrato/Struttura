...
\newl{\boxed{I(\xv{q} )=\overbrace{ \abs{\sum_{n1,n2,n3} e^{-i\xv{q} \cdot\xv{R} _n}} ^2 }^{\text{Fattore di Interferenza}} \overbrace{\abs{\sum_\alpha e^{-i\xv{q} \xv{r} _\alpha} \int_{V_{cella}} d^3r'\,\rho_\alpha(\xv{r} ')e^{-i\xv{q} \cdot\xv{r} ' } } ^2 }^{\text{Fattore di Struttura}} }.}
