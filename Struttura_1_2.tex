...
\subsection{Magnetismo nei Metalli}
...
\end{itemize}
Gli elettroni nelle bande dei metalli hanno notevoli gradi di libertà quindi l'idea di trattare gli elettroni come un gas è ragionevole e da risultati consistenti. In qeuesta verrà calcolata la suscettività paramegnetica di Pauli per un gas di elettroni. La derivazione può avvenire per vai statistica o per via variazionale, qui di seguito sarà argomentata la via statistica.
Consideriamo l'ambientazione del problema in un sistema \textbf{gran canonico}, in questo modo la funzione di partizione sarà quella gran canonica data da
