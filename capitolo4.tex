...
La maggior parte dei solidi \`e possibile rappresentarli come un reticolo, di una sua certa complessit\`a, che si ripete nello spazio in modo periodico. Il fatto che il reticolo di un cristallo, per definizione, sia dotato di una periodicit\`a spaziale permette di associarci in modo naturale la sua rappresentazione di Fourier nello spazio dei vettori $\xv{k} $. In un metallo ecc ecc ecc tight binding ....gas elettroni.... necessit\`a di studiare la dinamica del gas di elettroni ecc ecc ecc...
